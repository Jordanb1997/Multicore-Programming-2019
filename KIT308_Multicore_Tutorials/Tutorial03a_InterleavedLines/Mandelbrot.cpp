...
void mandelbrot(unsigned int threadID, unsigned int thread_total, unsigned int iterations, float centrex, float centrey, float scaley, unsigned int samples, unsigned int width, unsigned int height, unsigned int* out)
{
	...
	for (unsigned int iy = threadID; iy < height; iy += thread_total)
	{
