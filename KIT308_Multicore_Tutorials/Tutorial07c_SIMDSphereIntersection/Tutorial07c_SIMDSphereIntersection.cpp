...
bool areSpheresIntersected(const Spheres* sphereList, const Ray* r, float* t)
{
	...
	//: create SIMD vectors for each component of the ray (6 in all)
	...
	for (unsigned int i = 0; i < NUM_SPHERES / 8; ++i)
	{
		...
		for (unsigned int j = 0; j < 8; ++j)
		{
			...
			if (D >= 0.0f)									//: access the value from the new SIMD version of this variable
			{
				...
				//: access the value from the new SIMD version of this variable
				//: access the value from the new SIMD version of this variable
