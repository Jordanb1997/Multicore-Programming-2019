...
DWORD __stdcall mandelbrotThreadStart(LPVOID threadData)
{
	...
	mandelbrot(data->threadID, data->iterations, data->centrex, data->centrey, data->scaley, data->samples, data->width, data->height, data->out, data->sharedMem);
